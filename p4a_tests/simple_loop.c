/* Check if the program gives the correct output for a simple loop */
#include <stdlib.h>
#include <stdio.h>
#include <assert.h>
#include <string.h>
...
int main(int argc, char *argv[]) {
  ...
  assert(rc == 0);
  return compareOutput(buffer, fill, "/u/c/s/cs537-1/ta/tests/4a/tests/files/output/simple_loop.out");
}
